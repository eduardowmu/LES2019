...
{	public static void main(String[] args) throws InterruptedException
	{	String path = "junit\\chromedriver.exe";
		...
		{	driver.get("http://localhost:8080/ProjetoLES2019/login.jsp");
			...
			thread.sleep(2000);
			driver.getCurrentUrl();
			driver.findElement(By.name("numero")).sendKeys("9874563210789456");
			thread.sleep(1000);
			...
			thread.sleep(1000);
			driver.findElement(By.name("titular")).sendKeys("uuuvvv");
			thread.sleep(1000);
			...
			thread.sleep(1000);
			driver.findElement(By.name("email")).sendKeys("uuuvvv@gmail.com");
			thread.sleep(1000);
