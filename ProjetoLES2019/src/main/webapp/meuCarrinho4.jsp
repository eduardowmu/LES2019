		...
		<div style="padding-top:200px;">
			<table cellpadding="0" cellspacing="0" border="0"
				...
				<tbody>
					...
					<tr>
						...
						<td>Subtotal R$</td>
						<td>
							<input type="number" id="subTotal" name="subTotal" value="170" 
								disabled="disabled"/>
						</td>
					</tr>
					<tr>
						...
						<td>Total R$</td>
						<td>
							<input type="number" id="total" name="total" value="170"
								disabled="disabled"/>
			...
			<table align="center">
				<tr>
					...
					<td>
						<button type="button" id="addCupom" class="btn btn-primary form-control" 
