				...
				<div class="container">
					...
					<div class="collapse navbar-collapse" id="barra-navegacao">
						...
						<ul class="nav navbar-nav navbar-right">
							...
							<li><a name="logout" class="barra-direita" href="principal.html">Sair</a></li>
						</ul>
					</div>
				</div>
			</nav>
			...
			<div>
				<table class="table table-striped table-bordered table-hover table-condensed">
					...
					<tr>
						...
						<td class="linha" align="center">Ativo</td>
						<td align="center">
							<a href="lista2.jsp"><img src='imagens/disable_remove_delete_exit_close_11881.png'/></a>
						</td>
