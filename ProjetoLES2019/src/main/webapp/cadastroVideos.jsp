    		...
    		<nav class="navbar navbar-fixed-top navbar-inverse navbar-solid">
				<div class="container">
					...
					<div class="collapse navbar-collapse" id="barra-navegacao">
						<h2 class="barra"><b id=titulo>Cadastrar Videos</b></h2>
		...
		<div id="form" align="center">
			<% 	Result result = (Result)session.getAttribute("result");
				...
				{	if(!result.getMsg().equals(""))
					{out.print("<div class='alert alert-info'>"+result.getMsg()+"<div>");}
			...
			<fieldset>
				...
				<form action="VideoServlet" method="post">
						<input type="hidden" name="course_id" value="<%	if(course != null)
