			...
			<fieldset>
				<% Result result = (Result)session.getAttribute("result");
					...
					{	if(!result.getMsg().equals(""))
						{out.print("<div class='alert alert-warning' align='center'>"+result.getMsg()+"</div>");}
				...
				<form action="ClientServlet" method="post">
						<input type="hidden" name="id" id="id" value="<% if(client != null)	
						...
						<input type="date" îd="dtnasc" name="dtnasc" value="<% if(client != null)	
																			   {out.print(String.valueOf(client.getBirthday()));}
																			%>" required/>
						<br/><br/>
						E-mail:
